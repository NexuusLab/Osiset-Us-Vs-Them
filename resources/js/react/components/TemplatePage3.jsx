...
import { Page, Layout, Text, Card, Select, Icon, Stack, TextField, Loading, PageActions, Toast, Button,RangeSlider } from '@shopify/polaris';
...
export function TemplatePage3() {
  ...
  const handleTemplateTitle = useCallback((value) => setTemplateTitle(value), []);
  const handleTemplateTitleWeight = useCallback((value) => setTemplateTitleWeight(value), []);
  ...
  const submitData = async () => {
    ...
    let data = {
      ...
      border_color: colorValues?.border_color,
    ...
    useEffect(() => {
        ...
        document.documentElement.style.setProperty('--template2-row-bg-odd-color', colorValues?.background_color1);
        document.documentElement.style.setProperty('--template2-row-bg-even-color', colorValues?.background_color2);
        document.documentElement.style.setProperty('--template3-brand-bg-color', colorValues?.background_color1);
        document.documentElement.style.setProperty('--template3-competitor-bg-color', colorValues?.background_color2);
        document.documentElement.style.setProperty('--template4-odd-column-bg-color', colorValues?.background_color1);
        document.documentElement.style.setProperty('--template4-even-column-bg-color', colorValues?.background_color2);
        ...
        document.documentElement.style.setProperty('--template1-brand-text-color', colorValues?.text_brand_color);
        document.documentElement.style.setProperty('--template2-brand-text-color', colorValues?.text_brand_color);
        document.documentElement.style.setProperty('--template3-brand-text-color', colorValues?.text_brand_color);
        document.documentElement.style.setProperty('--template4-brand-text-color', colorValues?.text_brand_color);
        document.documentElement.style.setProperty('--template1-competitor-text-color', colorValues?.text_competitor_color);
        document.documentElement.style.setProperty('--template2-competitor-text-color', colorValues?.text_competitor_color);
        document.documentElement.style.setProperty('--template3-competitor-text-color', colorValues?.text_competitor_color);
        document.documentElement.style.setProperty('--template4-competitor-text-color', colorValues?.text_competitor_color);
        ...
        document.documentElement.style.setProperty('--template2-competitor-bg-color', colorValues?.competitor_backgorund1);
        ...
        document.documentElement.style.setProperty('--template4-advantage-text-color', colorValues?.text_advantages_color);
        document.documentElement.style.setProperty('--template3-brand-inner-text-color', colorValues?.text_brand_color_inside);
        document.documentElement.style.setProperty('--template3-competitor-inner-text-color', colorValues?.text_competitor_color_inside);
        document.documentElement.style.setProperty('--template4-brand-inner-text-color', colorValues?.text_brand_color_inside);
        document.documentElement.style.setProperty('--template4-competitor-inner-text-color', colorValues?.text_competitor_color_inside);
        document.documentElement.style.setProperty('--template2-border-color', colorValues?.border_color);
        document.documentElement.style.setProperty('--template4-border-color', colorValues?.border_color);
            ...
            <Layout.Section>
              ...
              {selectedTemplate === 1 || selectedTemplate === 2 ?
                ...
                >
                    ...
                    <div  className='Range-Inputs MarginZero'>
                ...
                >
                  ...
                  <div className='Color-Inputs MarginZero'>
                    ...
                    <div className='Color-Inputs'>
                        ...
                        <Stack>
                            <label
                                className={`${colorValues?.border_color === '#ffffff' || colorValues?.border_color === '#000000' ?
                                    'Color-Circle-Border' : ''} Color-Circle`}
                                style={{ backgroundColor: colorValues?.border_color }}>
                                <input type="color"
                                       value={colorValues?.border_color}
